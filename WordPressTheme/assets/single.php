        ...
        <div class="blog-list__inner inner">
            ...
            <div class="blog-list__first">
                <div class="blog-detail">
                    <time class="blog-detail__date" datetime="<?php echo get_the_date('Y-m-d'); ?>"><?php echo get_the_date(); ?></time>
                    ...
                    <div class="blog-detail__arrows">
                        ...
                        if ($prev_post) {
                            ...
                            echo '<div class="blog-detail__prev"><a href="' . esc_url($prev_post_url) . '"></a></div>';
                        } ?>
                        ...
                        if ($next_post) {
                            ...
                            echo '<div class="blog-detail__next"><a href="' . esc_url($next_post_url) . '"></a></div>';
                        }
                        ?>
                    </div>
                </div>
