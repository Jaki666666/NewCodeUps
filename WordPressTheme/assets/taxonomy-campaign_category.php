    ...
    <div class="content sub-page-content">
        <div class="content__inner inner">
            ...
            <ul class="links">
                ...
                ?>
                    <li class="links__item <?php if ($allterm->slug == $term) {echo 'is-active';} ?>"><a href="<?php echo get_term_link($allterm); ?>">
            ...
            <div class="content__campaign-cards campaign-cards">
                ...
                $args = array(
                    'post_type' => 'campaign', // カスタム投稿のスラッグ
                    'posts_per_page' => 4,
                    'paged' => $paged,
                    'tax_query' => array(
                        array(
                            'taxonomy' => 'campaign_category', // タクソノミースラッグ
                            'field' => 'slug',
