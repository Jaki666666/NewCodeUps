    ...
    <div class="content sub-page-content">
        <div class="content__inner inner">
            ...
            <ul class="links">
                ...
                ?>
                    <li class="links__item <?php if ($allterm->slug == $term) {
                                                echo 'is-active';
                        ...
                        <div class="voice-card">
                            <div class="voice-card__top">
                                ...
                                <div class="voice-card__animation-img animation-img">
                                    <img class="voice-card__img js-img-animation" src="<?php the_post_thumbnail_url('full'); ?>" alt="">
            ...
            <div class="contact__wrapper">
                ...
                <div class="contact__second-half">
                    ...
                    <div class="contact__btn-wrapper">
                        <a class="btn" href="../contact/index.html">
