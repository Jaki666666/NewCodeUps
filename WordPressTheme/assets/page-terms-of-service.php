...
<main>
    ...
    <div class="mv sub-page-mv">
        ...
        <h2 class="mv__title mv__title--sub-page">Terms of Service</h2>
    </div>
    ...
    <div class="content sub-page-content">
        <div class="content__inner inner inner--800">
            <img class="content__sub-page-decoration sub-page-decoration sub-page-decoration--800 sub-page-decoration--terms-of-service" src="<?php echo get_theme_file_uri('dist/assets/images/common/a-school-of-fish-campaign-sub.png'); ?>" alt="魚群の絵">

            <section class="content__terms-of-service terms-of-service">
                <?php the_content(); ?>
            </section>
        </div>
    </div>
